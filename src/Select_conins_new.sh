...
# add header
echo -e "chrom\tchromStart\tchromEnd\tstrand\tstart_gene\tend_gene" | cat - ../data/conin_python_long_coding.tsv > ../data/conin_python_long_coding_final.tsv
echo "added header"

#rm ../data/tmp
rm ../data/conin_python_long_coding.tsv
rm ../data/conin_python_coding.bed
